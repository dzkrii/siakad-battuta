            ...
            <div className="flex flex-col gap-y-8">
                ...
                {!props.checkFee && (
                    <div>
                        <Alert variant="orange">
                            ...
                            <AlertDescription>
                                Silahkan untuk melakukan pembayaran UKT terlebih dahulu agar anda dapat mengajukan kartu
                                rencana studi
                            </AlertDescription>
                        </Alert>
                    </div>
                ...
                <div className="flex w-full flex-col items-center justify-between gap-y-2 lg:flex-row">
                    <p className="text-sm text-muted-foreground">
                        Menampilkan <span className="font-medium">{meta.from ?? 0}</span> dari {meta.total} pembayaran
                    </p>
