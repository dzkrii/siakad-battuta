...
export default function CreateBackdated() {
    const { page_settings, schedules, current_classroom, selected_semester, selected_academic_year } = usePage().props;
    ...
    return (
        <div className="flex w-full flex-col pb-32">
            ...
            {/* Warning Banner for Backdated KRS */}
            <Card className="mb-6 border-amber-200 bg-amber-50">
                <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                        <IconAlertTriangle className="mt-0.5 size-6 text-amber-500" />
                        <div>
                            <h3 className="font-medium text-amber-800">Perhatian: Pengajuan KRS Tertinggal</h3>
                            <p className="text-amber-700">
                                Anda sedang mengajukan KRS untuk semester {selected_semester} pada tahun ajaran{' '}
                                {selected_academic_year.name}. Pastikan mata kuliah yang dipilih sesuai dengan kurikulum
                                semester tersebut.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="font-medium">{selected_academic_year.name}</p>
                                <p className="text-sm text-amber-600">
                                    Semester {selected_semester} {selected_semester % 2 === 1 ? '(Ganjil)' : '(Genap)'}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <form onSubmit={onHandleSubmit}>
                ...
                <div className="mt-8 flex flex-col gap-2 lg:flex-row lg:justify-end">
                    ...
                    >
                        ...
                        {processing ? 'Memproses...' : 'Simpan KRS Semester ' + selected_semester}
                    </Button>
                </div>
            </form>
        </div>
...
CreateBackdated.layout = (page) => <StudentLayout children={page} title={page.props.page_settings.title} />;
