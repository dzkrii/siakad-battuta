...
class CourseController extends Controller
{
    public function index(): Response
    {
        $courses = Course::query()
            ->select(['courses.id', 'courses.faculty_id', 'courses.department_id', 'courses.teacher_id', 'courses.academic_year_id', 'courses.name', 'courses.code', 'courses.credit', 'courses.semester', 'courses.created_at'])
