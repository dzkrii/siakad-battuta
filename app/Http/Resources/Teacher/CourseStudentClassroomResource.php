...
class CourseStudentClassroomResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'percentage' => [
                'attendance_percentage' => $attendance_percentage = round(($attendances_count / 16) * 10, 2),
                'task_percentage' => $task_percentage = round($tasks_count * 0.50, 2),
                'uts_percentage' => $uts_percentage = round($uts_count * 0.15, 2),
                'uas_percentage' => $uas_percentage = round($uas_count * 0.25, 2),
            ],
